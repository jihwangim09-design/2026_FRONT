...
// 입력 -> 처리 -> 출력
let fruitList = [ '사과', '바나나' ]; // 제공된 자료
let 과일이름 = prompt( ) // 1. 입력 2. 저장
let 존재여부 = fruitList.includes( 과일이름 ) // 3. 처리 : 입력받은 값이 fruitList에 존재하는가
if ( 존재여부 ) {// 3.출력 (분기)
    console.log( ' 이미 존재하는 과일입니다. ')
}else{
    fruitList.push( 과일이름 )
    console.log ( furitList )
}
*/
...
let 주민등록번호 = prompt()
// console.log ( 주민등록번호[7] ) // 문자열은 배열 취급, 문자열은 인덱스 처리 가능
...
// temp = 17*, 정수 1=17, 정수2=4
let temp = 정수1 // 두 변수간의 값 스왑/교체 하기 위한 임시 변수
// temp = 17, 정수1=4* , 정수2=4
정수1=정수2
//tmep = 17, 정수1=4, 정수2=17*
정수2 = temp;
